...
├── docs/
│   ├── analyzer.md
│   ├── coverage.md         # 미션 2 커버리지
│   └── coverage/           # gcovr HTML (coverage.html 등)
├── Report/
│   ├── 01_분석.md          ← 본 보고서
│   └── 02_RED.md           # 미션 2 RED 테스트 플랜
└── src/cpp/
...
| [docs/coverage.md](../docs/coverage.md) | 미션 2 도메인 line coverage |
| [02_RED.md](02_RED.md) | 미션 2 RED 테스트 플랜·실행 결과 |
